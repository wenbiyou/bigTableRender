      ...
      case 'initializing':
        return (
          <div style={{ textAlign: 'center', padding: '60px 20px' }}>
            ...
            <Paragraph type="secondary">正在生成10万行数据并启动Web Worker</Paragraph>
          </div>
        );
        ...
        <div style={{ display: 'flex', alignItems: 'flex-start', gap: 16 }}>
          <div style={{ flex: 1 }}>
            ...
            <Paragraph type="secondary">
              演示10万行 × 10列（100万单元格）数据的流畅滚动和快速排序，所有大数据操作都在Web
              Worker中执行，确保主线程不阻塞。
            </Paragraph>
          </div>
      ...
      <Card style={{ marginTop: 24 }}>
        ...
        <ol style={{ marginTop: 12, paddingLeft: 20 }}>
          <li key="instruction-1">
            <Text strong>滚动表格</Text>: 使用鼠标滚轮或拖动滚动条，体验10万行数据的流畅滚动
          </li>
          <li key="instruction-2">
            <Text strong>排序数据</Text>:
            点击任意列标题进行升序/降序排序，排序过程在Worker中异步执行
          </li>
          <li key="instruction-3">
            <Text strong>重置排序</Text>: 点击排序状态旁边的重置按钮恢复原始顺序
          </li>
          <li key="instruction-4">
            <Text strong>查看状态</Text>: 顶部状态栏显示总行数、可视范围和当前排序状态
          </li>
        </ol>
